...
export default function Search({ navigation, route, ...props }) {
  ...
  const [place, setPlace] = useState("Código ou Imobiliária")
  ...
  const categories = [
    ...
    {name: "Chácara", bgColor: "#0E1C36"},
    {name: "Cobertura", bgColor: "#0E1C36"},
    {name: "Galpão", bgColor: "#83A0A0"},
    {name: "Geminado", bgColor: "#E55381"},
    {name: "Prédio Comercial", bgColor: "#190B28"},
    {name: "Sala Comercial", bgColor: "#78A1BB"},
    {name: "Sítio", bgColor: "#684E32"},
